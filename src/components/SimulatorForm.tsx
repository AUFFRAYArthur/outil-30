...
const SimulatorForm: React.FC<SimulatorFormProps> = ({ inputs, onInputChange, onAllocationChange }) => {
  return (
    <Card>
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Paramètres de Simulation</h2>
      <div className="space-y-6">
        <div>
          <label htmlFor="resultatFiscal" className="flex items-center space-x-2 text-sm font-medium text-gray-700 mb-1">
        ...
        <div>
          <label htmlFor="cet" className="flex items-center space-x-2 text-sm font-medium text-gray-700 mb-1">
        ...
        <div>
          <label htmlFor="tauxIS" className="flex items-center space-x-2 text-sm font-medium text-gray-700 mb-1">
        ...
        <div>
          <label htmlFor="dureeInvestissement" className="flex items-center space-x-2 text-sm font-medium text-gray-700 mb-1">
